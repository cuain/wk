...
let userID = 'b589b0b5-a0b0-4099-8817-33b0616533dc';

const proxyIPs = ['proxyip.aliyun.fxxk.dedyn.io']; // workers.cloudflare.cyou  const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
