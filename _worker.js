...
const proxyIPs = ['cdn-b100.xn--b6gac.eu.org']; // workers.cloudflare.cyou  const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
